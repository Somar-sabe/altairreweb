    ...
    const contactInfo = [
        {
            ...
            phoneHref: 'tel:+971506251573', // Updated phoneHref to use "tel" URI
        },
        {
            id: 2,
            title: 'Need Live Support?',
            email: 'info@altairre.ae',
            emailHref: 'mailto:info@altairre.ae', // Updated emailHref to use "mailto" URI
        },
    ]
