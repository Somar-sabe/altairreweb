...
const ProperytyDescriptions = dynamic(() => import('./PropertyDescriptions'))
const PropertyFeaturesAminites = dynamic(
    () => import('./PropertyFeatureAmentities')
)
const PropertyVideo = dynamic(() => import('./PropertyVideo'))
const ScheduleTour = dynamic(() => import('./ScheduleTour'))
const FloorPlanCarousel = dynamic(
    () => import('@/components/off-plan/single/FloorPlanCarousel')
)
const PaymentPlan = dynamic(() => import('./PaymentPlan'))
...
const PropertyGallery = dynamic(
    () => import('@/components/shared/PhotoGallery')
)
const PropertyHeader = dynamic(() => import('./PropertyHeader'))
                    ...
                    <div className="ps-widget bgc-white bdrs12 default-box-shadow2 p30 mb30 overflow-hidden position-relative">
                        ...
                        <div className="row">
                            ...
                            <div className="col-lg-4">
                                <div className="column sticky top-[160px]">
