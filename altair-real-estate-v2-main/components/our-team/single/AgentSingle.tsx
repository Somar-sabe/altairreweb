...
import SingleAgentCta from './SingleAgenctCta'
import ListingItemsContainer from './ListingItemsContainer'
import AllReviews from './AllReviews'
import ReviewBoxForm from './ReviewBoxForm'
                        ...
                        <div className="row">
                            <div className="col-lg-12">
                                <div className="agent-single-details mt30 pb30 bdrb1">
                                    ...
                                    <p className="text">
                                        This 3-bed with a loft, 2-bath home in
                                        the gated community of The Hideout has
                                        it all. From the open floor plan to the
                                        abundance of light from the windows,
                                        this home is perfect for entertaining.
                                        The living room and dining room have
                                        vaulted ceilings and a beautiful
                                        fireplace. You will love spending time
                                        on the deck taking in the beautiful
                                        views. In the kitchen, you&apos;ll find
                                        stainless steel appliances and a tile
